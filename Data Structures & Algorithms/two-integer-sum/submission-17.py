class Solution:
    def twoSum(self, nums: List[int], target: int) -> List[int]:
        ...
        # Practical Usability
        # 1- the idea is that we can lookup with complement instead of searching brute force to find pairs
        # so if in inventory or ecommerce and you want to find another item for user that fit its total vouchers for example you can do that complement hash search 